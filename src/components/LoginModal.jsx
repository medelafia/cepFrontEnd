...
export default function LoginModal() {
  ...
  const verifierLogin = (res) => {
    ...
    switch (res.status) {
      case 200:
        return res.json();
      case 404:
        setErrors("you are not registred");
        return null;
      case 401 || 403:
  ...
  const loginSuccess = (token) => {
    ...
    if (user?.authority.startsWith("PROVIDER") || user?.authority == "ADMIN")
      navigate("/dashboard/");
    Swal.fire({
      timer: 2000,
          ...
          <div className="modal-body">
            {isloading ? (
              ...
              <>
                ...
                <h1 className="custom-text-primary text-capitalize text-center font-secondary">
                  login
                </h1>
                  ...
                  <form className="w-75 mb-3">
                    ...
                    <div className="form-group my-3">
                      ...
                      <div className="d-flex justify-content-end">
                        <Link onClick={closeLoginModal} to="/forgotPassword">
                          forgot password
                        </Link>
                      </div>
                    </div>
                    <div className="form-group my-1 d-flex">
                      ...
                      <label
                        htmlFor="remember-me"
                        className="text-lowercase mx-1"
                      >
                        remember me
                      </label>
                    </div>
                    <button
                      className="custom-btn-secondary btn my-1 w-100"
                      type="submit"
