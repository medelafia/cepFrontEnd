        ...
        <div className="w-100">
            <div className="px-5 py-2 d-flex align-items-center justify-content-start w-100">
                <ul className="d-flex w-100 justify-content-around text-capitalize border-bottom">
                    ...
                    <li className={`mx-2 pb-2 ${pathname == "/offers/hotels" && "custom-border-bottom"}`}><Link to={"/offers/hotels"} className="text-dark text-decoration-none  p-3 rounded-pill">hotels</Link></li>
                    ...
                    <li className={`mx-2 pb-2 ${pathname == "/offers/destinations" && "custom-border-bottom"}`}><Link to={"/offers/destinations"} className="text-dark text-decoration-none  p-3 rounded-pill">destinations</Link></li>
