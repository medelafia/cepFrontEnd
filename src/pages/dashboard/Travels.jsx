...
export default function Travels() {
  ...
  return (
    <DataPage dataUrl={"http://localhost:8089/travelAgencies/organizedTravels"} deletePath={`http://localhost:8089/travelAgencies/organizedTravels/`} dataAddingPath={"/dashboard/addTravel"} columns={columns} />
  );
}
