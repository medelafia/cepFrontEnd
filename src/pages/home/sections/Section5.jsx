        ...
        <div className="custom-container my-5">
            ...
            >
                <div className="col-sm-12 col-lg-8 d-flex align-items-start justify-content-center flex-column">
                    <h1 className="text-capitalize custom-text-primary bold">find your near hotels</h1>
                    <div className="my-3 text-capitalize">ai model that can find your nearby hotels by location </div>
                    <button className="btn custom-bg-primary text-white rounded-pill px-5 mt-2" onClick={() => navigate("/offers/hotels")}>try it now!</button>
                </div>
