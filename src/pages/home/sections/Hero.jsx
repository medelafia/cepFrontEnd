    ...
    return (
        <div className="hero-section">
            <div className="custom-container d-flex flex-column align-items-center justify-content-center h-100">
                <div className="hero-title custom-text-secondary text-center text-capitalize">
                    explore the world by <br/>travelboot
                </div>
                <div className="hero-text my-4 text-center custom-text-secondary text-capitalize">
